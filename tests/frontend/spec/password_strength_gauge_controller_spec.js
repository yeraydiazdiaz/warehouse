...
import PasswordStrengthGaugeController from "../../../warehouse/static/js/warehouse/controllers/password_match_controller";
...
describe("PasswordStrengthGaugeController", function() {
  ...
  before(function() {
    registerApplication.call(this, "password-match", PasswordStrengthGaugeController);
